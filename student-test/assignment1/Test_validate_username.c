...
{
    const char * first_name = my_username();
    const char * second_name = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(first_name, second_name, "These strings are equal");
}
